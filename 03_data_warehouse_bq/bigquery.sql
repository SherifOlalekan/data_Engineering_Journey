...
CREATE OR REPLACE EXTERNAL TABLE `my-de-journey.zoomcamp_data.external-yellow-taxi-data`
OPTIONS (
  format = 'parquet',
  uris = ['gs://olalekanroy-data-bucket/yellow_tripdata_2024-*.parquet']
);

-- Check yello trip data
SELECT * FROM `my-de-journey.zoomcamp_data.external-yellow-taxi-data` LIMIT 10
